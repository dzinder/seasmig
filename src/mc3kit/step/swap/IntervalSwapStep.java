...
public class IntervalSwapStep implements Step
{
	...
	int chainCount;
	private long swapInterval;

	/*** METHODS 
	 * @throws IOException ***/

	protected IntervalSwapStep() { }

	public IntervalSwapStep(ChainParity swapParity, long statsEvery, long swapInterval) throws IOException
	{
	...
	private class Swapper implements Task
	{
		...
		public void step(Chain[] chains) throws MC3KitException
		{
			...
			if (iterationCount % swapInterval == 0) {
